...
class EDD_Extension_Activation {
	...
	public $ecourse, $plugin_path, $plugin_file, $has_edd, $edd_base;
	...
	public function __construct( $plugin_path, $plugin_file ) {
		...
		if ( isset( $plugins[ $this->plugin_path . '/' . $this->plugin_file ]['Name'] ) ) {
			$this->ecourse = str_replace( 'Easy Digital Downloads - ', '', $plugins[ $this->plugin_path . '/' . $this->plugin_file ]['Name'] );
		} else {
			$this->ecourse = __( 'This plugin', 'edd' );
		}
	...
	public function missing_edd_notice() {
		...
		echo '<div class="error"><p>' . $this->ecourse . sprintf( __( ' requires Easy Digital Downloads! Please %s to continue!', 'edd-extension-activation' ), $link ) . '</p></div>';
	}
}
